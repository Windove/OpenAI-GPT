...
## OpenAI API calls to create a story from the frames and prompt
...
## OpenAI API calls to create audio from the story generated
...
def main():
    ...
    if uploaded_file is not None:
        ...
        prompt = st.text_area(
            "Prompt", value="These are frames of a video. Create a short voiceover script that is highly engaging describing what is happening.")
    ...
    if st.button('Generate', type="primary") and uploaded_file is not None:
        with st.spinner('Processing...'):
            ...
            est_word_count = video_duration * 3
